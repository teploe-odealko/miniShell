...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/23 09:48:01 by ptycho            #+#    #+#             */
/*   Updated: 2021/01/23 09:48:05 by ptycho           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct		s_dict
{
	...
	void			(*set_value_by_key)(struct s_dict *self,
			char *key, char *value);
...
char				*cut_off_word(char **str, int start,
					int finish, char *trim_set);
...
void				pipe_handler_children(int *pipe_fd,
					t_dict *dict, char *left_com);
